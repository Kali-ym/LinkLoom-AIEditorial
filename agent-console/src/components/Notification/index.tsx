import { type FlexboxProps, ActionIcon, Flexbox } from '@lobehub/ui';
...
/** Upstream `components/Notification` — §C.58 TelemetryNotification shell */
export const Notification = memo<NotificationProps>(function Notification({
  mobile,
  children,
  show,
  onCancel,
