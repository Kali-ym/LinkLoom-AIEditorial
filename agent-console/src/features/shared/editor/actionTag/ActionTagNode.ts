...
export class ActionTagNode extends DecoratorNode<unknown> implements HeadlessRenderableNode {
  ...
  renderHeadless({ key }: HeadlessRenderContext) {
    return createElement(
      'span',
      { key, style: { verticalAlign: -3 } },
      createElement(ActionMention, {
