import { type FlexboxProps, Flexbox, Skeleton } from '@lobehub/ui';
import { cssVar } from 'antd-style';
import { memo } from 'react';

export const SkeletonItem = memo<
  { avatarSize?: number } & Omit<FlexboxProps, 'children'>
>(function SkeletonItem({ padding = 6, height = 36, style, avatarSize = 28, ...rest }) {
  return (
    <Flexbox
      horizontal
      align="center"
...
export const SkeletonList = memo<{ rows?: number } & Omit<FlexboxProps, 'children'>>(
  function SkeletonList({ rows = 3, ...rest }) {
    return (
      <Flexbox gap={2} {...rest}>
